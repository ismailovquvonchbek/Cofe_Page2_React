        ...
        <>
            <footer className="footer">
                <div className="container">
                    <a className="ftr__link" href="#link">
                        <img className="ftr__logo" src={FooterLogo} alt="Logo" width={236} height={26} />
                    </a>

                    <ul className="ftr__list">
                        <li className="ftr__item">
                            <a className="ftr__link" href="#link">Home</a>
                        </li>

                        <li className="ftr__item">
                            <a className="ftr__link" href="#link">About us</a>
                        </li>

                        <li className="ftr__item">
                            <a className="ftr__link" href="#link">Create your plan</a>
                        </li>
                    </ul>

                    <div className="ftr__logos">
                        <a className="ftr__brends" href="#link">
